...
namespace Kvant
{
    ...
    public class Stream : MonoBehaviour
    {
        ...
        var a = MidiMaster.GetKnob(knobNumber1);
		var b = MidiMaster.GetKnob(knobNumber2);
		var c = MidiMaster.GetKnob(knobNumber3);
        var d = MidiMaster.GetKnob(knobNumber4);
        var e = MidiMaster.GetKnob(knobNumber5);
        var f = MidiMaster.GetKnob(knobNumber6);
        var g = MidiMaster.GetKnob(knobNumber7);
        var h = MidiMaster.GetKnob(knobNumber8);
        var i = MidiMaster.GetKnob(knobNumber9);
